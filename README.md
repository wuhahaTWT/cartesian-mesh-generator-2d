...
新增可单独加密壁法向的原生矩形网格：512格诊断平板的y+约.33–.94，独立离散方程审核通过；更细的两例仍未通过线性求解精度门，失败记录保留。修复了一个BiCGStab中断及残差消去问题，尚不能称近壁/高Re湍流已验收。[真实网格与未通过项](docs/CURRENT_STATE_CN.md#当前改进各向异性近壁网格与浮点残差恢复)
