...
开发分支已有**实验性稳态SST-2003m耦合核心**：k/omega更新后的湍黏度进入SIMPLE及完整对称应力，最终同时核对质量、动量和两条湍流方程。196/900格通道通过独立离散方程审核，零k极限恢复原层流。**标准湍流工况、近壁精度和规模性能尚未验收，App仍未开放湍流。** [真实场、耗时与支持边界](docs/CURRENT_STATE_CN.md#当前改进实验性稳态sst与simple耦合)
