...
新增预设空间扩散系数基础：正方形与真实斜边Cut-cell各三档网格上，限制线性输运误差随细化接近二阶下降，逐面本构与逐格守恒独立审核通过。当前限冻结载流的核心/CLI；变黏度、同步变物性与SST尚未实现。[真实网格、误差及适用范围](docs/CURRENT_STATE_CN.md#当前改进守恒空间扩散场)
