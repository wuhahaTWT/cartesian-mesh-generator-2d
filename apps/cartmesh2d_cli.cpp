...
// W1's geometric grid-corner weld budget. This only canonicalizes intersections
// already within one ten-thousandth of a local cell width.
...
int main(int argc, char** argv) {
    ...
    // Create the output directory once before anything downstream can write.
